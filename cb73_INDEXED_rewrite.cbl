      ...
      * Author: Accampora.
      * Date: 15-10-2023.
      * Purpose: Ler arquivo indexado e atualizar com REWRITE
      *
      ****************************************************************
      ...
      *
       ...
       INICIO.
           DISPLAY
           "V:2.02 - Ler arquivo indexado com acesso randomico "
           " - Atualizar com REWRITE  "
       ...
       PROCESS-PARA.
           ...
           READ INFL
               ...
               NOT INVALID KEY
                   ...
                   " ST=" FS-INFL
               END-READ.
      * ==>> MODIFICA NOME E ATUALIZA REGISTRO
           MOVE "EMPRESA ATUALIZADA  " TO EMP-NAME
           REWRITE INFL-REC
               INVALID KEY
                   DISPLAY 'REWRITE INVALID KEY st=' FS-INFL
                   " KEY=" EMP-ID
                   GO TO PROCESS-EXIT-PARA
               NOT INVALID KEY
