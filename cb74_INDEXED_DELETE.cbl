      ...
      * Author: Accampora.
      * Date: 24-10-2023.
      * Purpose: Ler arquivo indexado e DELETA CHAVE COM
      *     COMANDO DELETE
      ****************************************************************
      ...
      *
       ...
       INICIO.
           DISPLAY
           "V:2.04 - Ler arquivo indexado com acesso randomico "
           " -DELETAR CHAVE X com DELETE "
      ...
      *================================
       PROCESS-PARA.
           ...
           READ INFL
               KEY IS EMP-ID
               INVALID KEY
                   DISPLAY ' CHAVE A SER DELETADA NAO ENCONTRADA st='
                   FS-INFL " CHAVE=" EMP-ID
      ...
      * ==>> DELETA REGISTRO LIDO
           ...
           DELETE INFL RECORD
               INVALID KEY
                   DISPLAY ' DELETE INVALID KEY st=' FS-INFL
                   " KEY=" EMP-ID
                   GO TO PROCESS-EXIT-PARA
               NOT INVALID KEY
      ...
      *=================  FIM ======
       ...
       inicializa-arquivo.
           ...
           write infl-rec  invalid key
                 ...
                 stop run.
           display 'gravou 1 CHv=' EMP-ID ' ' emp-name " ST=" FS-INFL.
           ...
           write infl-rec  invalid key
                 ...
                 stop run.
           display 'gravou 2 CHv=' EMP-ID ' ' emp-name " ST=" FS-INFL.
           ...
           write infl-rec  invalid key
                 ...
                 stop run.
           display 'gravou 3 CHv=' EMP-ID ' ' emp-name " ST=" FS-INFL.
       fim-inicia.
           exit.
      *===================================
